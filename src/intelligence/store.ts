...
export class IntelligenceStore {
  ...
  constructor(opts: StoreOptions = {}) {
    ...
    this.projectPath = join(cwd, '.hunt-agent', 'intelligence', 'scenarios.jsonl');
    this.personalPath = join(home, '.hunt-agent', 'intelligence', 'scenarios.jsonl');
  }
...
export function formatIntelligenceContext(results: SearchResult[]): string {
  ...
  const out: string[] = [];
  out.push('# Local Hunt-agent Intelligence');
  out.push('');
  out.push(
