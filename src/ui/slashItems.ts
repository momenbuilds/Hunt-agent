...
export const SLASH_ITEMS: SlashItem[] = [
  ...
  {
    name: '/provider',
    args: '[list|status|add|remove]',
    description: 'pick or manage model providers',
  },
  {
    name: '/model',
    args: '<id|list|route|routes|fallback|status|test|bench>',
    description: 'switch, route, inspect, or test models',
  },
  {
    name: '/verify',
    args: '[finding-id] [--models a,b]',
    description: 'run reasoning-only finding verification with verifier routing',
  },
  ...
  { name: '/burp', args: '[port]', description: 'start the local Burp/hunt-agent listener' },
  ...
  { name: '/exit', description: 'quit hunt-agent' },
];
