...
const PING_TOOL_NAME = '__hunt_agent_probe_ping';
    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a tool-calling probe. Your ONLY response must be a call to the `__hunt_agent_probe_ping` tool with value="ok". Do not produce any text. Do not call any other tool.',
      },
