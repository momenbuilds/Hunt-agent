...
TARGETS=(
  "bun-darwin-arm64:hunt-agent-darwin-arm64"
  "bun-darwin-x64-baseline:hunt-agent-darwin-x64"
  "bun-linux-x64-baseline:hunt-agent-linux-x64"
  "bun-linux-arm64:hunt-agent-linux-arm64"
)
